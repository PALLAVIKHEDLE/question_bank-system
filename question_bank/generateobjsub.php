  ...
  display: none;
	...
	<div class="col-sm-9">
        ...
        <div class="col-md-3">
			...
			<select class="form-control" name="technology[]" id="technology" class="total">
		...
		<input type="number" name="limit_qus[]" class="form-control" id="limit_que" class="que ">
...
$('.add-type').click(function(e) {
	...
	$("#area").hide();
	$("#myCheck :checkbox").click( function(){
